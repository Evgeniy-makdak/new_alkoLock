...
export interface IEventsTypeResponse {
  data: IEventType[];
}
...
export interface IAccountUser {
  isActive(isActive: boolean): unknown;
  id: ID;
  login: string;
  firstName: string;
  surname: string;
...
export interface ISummary {
  ...
  waterTableRatioA: string;
  zeroCalibration: string;
  cuvetteCapacity: string;
  waterTableType: string;
  temperature: string;
  testParams: any;
  description: any;
  longitude: string | number;
...
export interface IEmailNotificationGroup {
  email: string;
  subscriptions: IEmailSubscription[];
}

export interface EmailNotificationResponse {
  content: IEmailNotificationGroup[];
  totalElements: number;
  totalPages: number;
  size: number;
  number: number;
...
export interface IEmailNotificationUpdate {
  eventTypeId: number;
  startTime: string;
  endTime: string;
}
